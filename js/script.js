...
/* =========================================================================
   ...
   ========================================================================= */
const manzana   = { id: 1, nombre: "Manzana roja", categoria: "fruta",   precio: 20.5,  stock: 8,  icono: "../Proyecto_1/image/manzana.png" };
const pina      = { id: 2, nombre: "Piña",         categoria: "fruta",   precio: 15.35, stock: 5,  icono: "../Proyecto_1/image/piña.png" };
const pera      = { id: 3, nombre: "Pera",         categoria: "fruta",   precio: 5.45,  stock: 12, icono: "../Proyecto_1/image/pera.png" };
const melon     = { id: 4, nombre: "Melón",        categoria: "fruta",   precio: 6.15,  stock: 3,  icono: "../Proyecto_1/image/melon.png" };
const zanahoria = { id: 5, nombre: "Zanahoria",    categoria: "verdura", precio: 3.2,   stock: 14, icono: "../Proyecto_1/image/zanahoria.png" };
const tomate    = { id: 6, nombre: "Tomate",       categoria: "verdura", precio: 4.75,  stock: 6,  icono: "../Proyecto_1/image/tomate.png" };
const jugo      = { id: 7, nombre: "Jugo natural", categoria: "bebida",  precio: 12.0,  stock: 6,  icono: "../Proyecto_1/image/jugo.png" };
const cocoAgua  = { id: 8, nombre: "Agua de coco", categoria: "bebida",  precio: 8.9,   stock: 4,  icono: "../Proyecto_1/image/aguaCoco.png" };
const jugoNaranja = { id: 9, nombre: "Jugo de naranja", categoria: "bebida", precio: 10.0, stock: 2, icono: "../Proyecto_1/image/jugoNaranja.png" };
const papaya   = { id: 10, nombre: "Papaya", categoria: "fruta", precio: 7.5, stock: 4, icono: "../Proyecto_1/image/papaya.png" };
const guayaba   = { id: 11, nombre: "Guayaba", categoria: "fruta", precio: 6.0, stock: 5, icono: "../Proyecto_1/image/guayaba.png" };

// Array que contiene todos los objetos del inventario
const inventarioProductos = [manzana, pina, pera, melon, zanahoria, tomate, jugo, cocoAgua, jugoNaranja, papaya, guayaba];
